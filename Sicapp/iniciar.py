...
def iniciarCatalogo():
    ...
    Cuenta.objects.create(codCuenta="AC017", codigoN="11414", nombre="Losas ", tipoCuenta="Activo")
    ...
    Cuenta.objects.create(codCuenta="CRA004", codigoN="513", nombre="Costo de lo Vendido", tipoCuenta="Cuentas de Resultado Deudor")
